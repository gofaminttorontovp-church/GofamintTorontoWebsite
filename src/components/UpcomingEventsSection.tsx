...
/**
 * The dated list under the flyers: the plain reference version of what the
 * announcements carry. It came over from the Events page when that page was
 * folded into the home page, and reads the same list the admin tool edits.
 */
export default function UpcomingEventsSection() {
  return (
    <section id="upcoming" className="scroll-mt-20 md:scroll-mt-24" style={{ background: "#ffffff", padding: "100px 32px" }}>
